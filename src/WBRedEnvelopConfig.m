...
static NSString * const kDelaySecondsKey = @"YHDelaySecondsKey";
static NSString * const kSportCountKey = @"YHDelaySecondsKey";
static NSString * const kAutoReceiveRedEnvelopKey = @"YHWeChatRedEnvelopSwitchKey";
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        _sportCount = [[NSUserDefaults standardUserDefaults] integerForKey:kSportCountKey];
...
- (void)setSportCount:(NSInteger)sportCount {
    _sportCount = sportCount;
    [[NSUserDefaults standardUserDefaults] setInteger:sportCount forKey:kSportCountKey];
    [[NSUserDefaults standardUserDefaults] synchronize];
}
